...
| Topic | Read when… |
|-------|------------|
| [Per-env isolation and port substitution](./ai/per-env-isolation.md) | …configuring `COMPOSE_PROJECT_NAME` namespacing or `WSD_PORT_*` placeholders in `compose.yaml` |
