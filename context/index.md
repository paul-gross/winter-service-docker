...
After `winter ws init` clones the extension, walk the user through [workflow-setup.md](./workflow-setup.md) to scaffold
and populate `workspace:/.winter/config/winter-service-docker/` — the `config.toml` and compose files every feature
worktree needs.
